...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002157466253"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002483920475"))
...
#bot stats
BOT_STATS_TEXT = os.environ.get("BOTS_STATS_TEXT","<b>BOT UPTIME 🕊️</b>\n{uptime}")
#send custom message when user interact with bot
USER_REPLY_TEXT = os.environ.get("USER_REPLY_TEXT", "<b>Don't send me messages directly I'm only working for @km_portal </b>‼️")

#your bot token here from https://telegram.me/BotFather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7eQ") 
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://mendak:harshit9801@cluster0.1ni8o.mongodb.net/?retryWrites=true&w=majority")
#your database name
...
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}\n\nI am file store bot of @xclusive_backup @km_portal")
#your telegram tag without @
OWNER_TAG = os.environ.get("OWNER_TAG", "LAURENbale")
...
SHORTLINK_API_URL = os.environ.get("SHORTLINK_API_URL", "False")
# SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "")
#use this key if not working ☠️ (jokin!!)
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "False")
#add your custom time in secs for shortlink expiration.
# 24hr = 86400
# 12hr = 43200
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', "86400")) # Add time in seconds
#put TRUE if you want shortner in every link generated by the bot.
U_S_E_P = False if (True if os.environ.get('U_S_E_P', "FALSE") == "TRUE" else False) and (USE_SHORTLINK) else False
#Tutorial video for the user of your shortner on how to download.
TUT_VID = os.environ.get("TUT_VID","https://t.me/km_portal")
...
USE_PAYMENT = False if (True if os.environ.get("USE_PAYMENT", "FALSE") == "FALSE" else False) and (USE_SHORTLINK) else False
#UPI ID
UPI_ID = os.environ.get("UPI_ID", " ")
#UPI QR CODE IMAGE
UPI_IMAGE_URL = os.environ.get("UPI_IMAGE_URL", "")
#SCREENSHOT URL of ADMIN for verification of payments
SCREENSHOT_URL = os.environ.get("SCREENSHOT_URL", f"t.me/shitnigga_bot")
#Time and its price
#7 Days
...
ADMIN_LIST = os.environ.get("ADMINS", "7826195958").split()
